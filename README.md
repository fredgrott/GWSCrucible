...
Library to move data from data layer in the correct thread.
...
```groovy
compile 'com.github.shareme:GWSCrucible:{latest-release-number}@aar'
```
...
[ Pedro Vicente GÃ³mez SÃ¡nchez EffectiveAndroidUI]()
